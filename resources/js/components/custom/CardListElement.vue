...
const {
  ...
  hasBottomRight,
  cardBackgroundClass,
} = getLinkArrows(props.card, true);
</script>

<template>
  <Link
    :href="route('card.show', card.id)"
    class="group flex cursor-pointer flex-row space-x-3"
  >
    <!-- Image logic -->
    <div
      class="relative flex aspect-square basis-1/4 items-center justify-center"
    >
    ...
    <div class="grid flex-1 grid-flow-col grid-cols-12 grid-rows-4 gap-y-2">
      ...
      <div
        class="col-start-12 col-end-12 row-start-1 row-end-5 rounded-3xl text-[rgba(0,0,0,0)]"
      ...
      <div
        class="col-start-6 col-end-11 row-start-2 overflow-hidden text-end text-nowrap text-ellipsis"
      >
      ...
      <div
        class="col-span-11 row-start-3 overflow-hidden text-nowrap text-ellipsis"
      >
