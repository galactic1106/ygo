        ...
        <div class="card-body">
            <form action="{{ route('decks.create') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="deck-name" name="name" required maxlength="64" placeholder="Enter deck name">
                </div>
                <div class="mb-3">
                    ...
                    <tbody>
                        @foreach($decks as $deck)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('decks.delete', $deck->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Are you sure you want to delete this deck?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="btn btn-danger btn-sm">Delete</button>
                                    </form>
                                    <a href="{{ route('decks.show', $deck->id) }}" class="btn btn-primary btn-sm">View</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
